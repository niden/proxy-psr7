...
{
    /**
     * Tests Phalcon\Proxy\Psr7\Http\Message\Uri :: __toString()
     *
    ...
    /**
     * Tests Phalcon\Proxy\Psr7\Http\Message\Uri :: __toString() - path no lead slash
     *
     * @author Phalcon Team <team@phalcon.io>
     * @since  2019-02-07
     */
    ...
    /**
     * Tests Phalcon\Proxy\Psr7\Http\Message\Uri :: __toString() - path many slashes
     *
     * @author Phalcon Team <team@phalcon.io>
     * @since  2019-06-01
     */
